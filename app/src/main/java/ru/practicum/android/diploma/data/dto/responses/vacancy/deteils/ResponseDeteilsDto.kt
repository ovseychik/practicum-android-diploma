...
data class ResponseDetailsDto(
    ...
    @SerializedName("alternate_url") val alternateUrl: String, // ссылка на вакансию
    ...
    @SerializedName("key_skills") val keySkills: List<KeySkill>, // основные навыки
    @SerializedName(" professional_roles") val professionalRoles: List<ProfessionalRole>, // внури названия профессиональных ролей
    @SerializedName("published_at") val publishedAt: String, // дата и время публикации вакансии в формате "2013-07-08T16:17:21+0400"
) : Response()
